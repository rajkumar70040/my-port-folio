    ...
    <FooterContainer>
      <FooterWrapper>
        ...
        <SocialMediaIcons>
          ...
          <SocialMediaIcon href="mailto:rajkmar2533@gmail.com" target="display" rel="noopener noreferrer">
              <EmailIcon />
          </SocialMediaIcon>
        </SocialMediaIcons>
        <Copyright>&copy; {currentYear} Rajkumar Yadav. All rights reserved.</Copyright>
      </FooterWrapper>
    </FooterContainer>
  );
};
